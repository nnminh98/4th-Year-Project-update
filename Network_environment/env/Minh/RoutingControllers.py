...
class RLRouting(RoutingAlgorithm):
    ...
    def route_packet(self, packet):
        ...
        if self.route_here is not None:
            ...
            #print("Route here is " + str(route_here.id))
    ...
    def set(self, action):
        ...
        #print("Selected dest route is " + str(selected_action.id))
        selected_link = self.node.routes["{}_{}".format(self.node.id, selected_action.id)]
        #print("Selected route is " + str(selected_link.id))
        self.set_route_here(link=selected_link)
        #print("set_route_here is " + str(self.route_here.id))
